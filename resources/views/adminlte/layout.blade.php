        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="/" class="brand-link">
                    ...
                    <img src="/img/logo.jpg" alt="Comunidades Logo" class="brand-image elevation-3" style="opacity: .8">
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright&copy;{{ date('Y') }} <a href="https://github.com/randionfernandez/comunidades">Randion</a></strong>
            </footer>
        </div>
        <!-- ./wrapper -->
